...
#ifndef XENEON_UPDATE_REPO
#define XENEON_UPDATE_REPO "aabdelghani/corsair-xeneon-edge-linux"
#endif
...
QString apiUrl()
{
    return QStringLiteral("https://api.github.com/repos/%1/releases/latest")
        .arg(QLatin1String(XENEON_UPDATE_REPO));
}
...
{
    return Version::parse(QStringLiteral(XENEON_VERSION));
}
...
void UpdateChecker::check(bool manual)
{
    ...
    req.setHeader(QNetworkRequest::UserAgentHeader,
                  QStringLiteral("xeneon-ctl/%1").arg(QLatin1String(XENEON_VERSION)));
